...
import {
  ...
  ChevronDown, X, MoreHorizontal, Store
} from "lucide-react";
...
export default function NexusERPFull() {
  ...
  function addUser() {
    ...
    updateDb(prev => ({ ...prev, users: [item, ...prev.users] }), { action: "Criou usuário", module: "Admin", detail: item.name });
    ...
    <div className="min-h-screen bg-[#eef3f9] flex">
      ...
      <Dialog open={modal === "product"} onOpenChange={open => !open && closeModal()}>
        <DialogContent className="rounded-[20px] max-w-lg">
          ...
          <DialogFooter className="mt-2">
            ...
            <Button onClick={addProduct} className="rounded-xl bg-[#2453ff] hover:bg-[#1f46d6] text-white">Salvar Produto</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={modal === "customer"} onOpenChange={open => !open && closeModal()}>
        <DialogContent className="rounded-[20px] max-w-md">
          ...
          <DialogFooter className="mt-2">
            <Button variant="outline" onClick={closeModal} className="rounded-xl">Cancelar</Button>
            <Button onClick={addCustomer} className="rounded-xl bg-[#2453ff] hover:bg-[#1f46d6] text-white">Salvar Cliente</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={modal === "supplier"} onOpenChange={open => !open && closeModal()}>
        <DialogContent className="rounded-[20px] max-w-md">
          ...
          <DialogFooter className="mt-2">
            <Button variant="outline" onClick={closeModal} className="rounded-xl">Cancelar</Button>
            <Button onClick={addSupplier} className="rounded-xl bg-[#2453ff] hover:bg-[#1f46d6] text-white">Salvar Fornecedor</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={modal === "user"} onOpenChange={open => !open && closeModal()}>
        <DialogContent className="rounded-[20px] max-w-md">
          ...
          <DialogFooter className="mt-2">
            <Button variant="outline" onClick={closeModal} className="rounded-xl">Cancelar</Button>
            <Button onClick={addUser} className="rounded-xl bg-[#2453ff] hover:bg-[#1f46d6] text-white">Salvar Usuário</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={modal === "payable"} onOpenChange={open => !open && closeModal()}>
        <DialogContent className="rounded-[20px] max-w-md">
          ...
          <DialogFooter className="mt-2">
            <Button variant="outline" onClick={closeModal} className="rounded-xl">Cancelar</Button>
            <Button onClick={addPayable} className="rounded-xl bg-[#ef4444] hover:bg-red-600 text-white">Registrar Despesa</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={modal === "receivable"} onOpenChange={open => !open && closeModal()}>
        <DialogContent className="rounded-[20px] max-w-md">
          ...
          <DialogFooter className="mt-2">
            <Button variant="outline" onClick={closeModal} className="rounded-xl">Cancelar</Button>
            <Button onClick={addReceivable} className="rounded-xl bg-[#10b981] hover:bg-emerald-600 text-white">Registrar Receita</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
